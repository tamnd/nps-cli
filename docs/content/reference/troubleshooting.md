...
Most of these come down to network reality or how nps serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nps rate-limits like any public site. nps already paces
...
Where a surface is gated, nps reads a cookie or token you supply
...
`nps`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nps actually did
